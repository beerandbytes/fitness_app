                ...
                try {
                    ...
                    if (existing) {
                        ...
                        if (existing.name.startsWith('Ejercicio wger-') && exerciseName) {
                            ...
                            updateData.name_es = exerciseName; // El nombre de wger ya viene en español
                        }
                        
                        // Actualizar name_es si falta (el nombre de wger ya viene en español)
                        if (exerciseName && (!existing.name_es || existing.name_es.trim().length === 0)) {
                        ...
                        try {
                            await db.insert(exercises).values({
                                name: exerciseName,
                                name_es: exerciseName, // El nombre de wger ya viene en español
                                category: category,
