...
const { cleanupUserByEmail, cleanupFoodsByNames } = require('./helpers/testHelpers');
...
describe('Foods Routes', () => {
    ...
    beforeAll(async () => {
        ...
        await cleanupUserByEmail('foods-test@example.com');
        await cleanupFoodsByNames(['Test Food', 'Search Test Food', 'Duplicate Food']);
