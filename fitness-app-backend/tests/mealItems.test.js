...
const { cleanupUserByEmail, cleanupFoodByName } = require('./helpers/testHelpers');
...
describe('Meal Items Routes', () => {
    ...
    beforeAll(async () => {
        ...
        await cleanupUserByEmail('mealitems-test@example.com');
        await cleanupFoodByName('Meal Items Test Food');
