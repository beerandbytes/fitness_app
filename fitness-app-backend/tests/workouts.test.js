...
describe('Workouts Routes', () => {
    ...
    beforeAll(async () => {
        ...
        await cleanupUserByEmail('workouts-test@example.com');
        await cleanupExerciseByName('Workout Test Exercise');
    ...
    afterAll(async () => {
        // Limpiar datos de prueba (el helper cleanupUserByEmail limpia todo)
        await cleanupExerciseByName('Workout Test Exercise');
        await cleanupUserByEmail('workouts-test@example.com');
    });
