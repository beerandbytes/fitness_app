...
const { cleanupUserByEmail, cleanupExerciseByName } = require('./helpers/testHelpers');
...
describe('Exercises Routes', () => {
    ...
    beforeAll(async () => {
        ...
        await cleanupExerciseByName('Test Exercise');
        await cleanupUserByEmail('exercises-test@example.com');
    ...
    describe('POST /api/exercises', () => {
        ...
        it('should reject duplicate exercise name', async () => {
            ...
            await db.insert(exercises).values({
                name: 'Test Exercise',
                category: 'Fuerza',
                default_calories_per_minute: '8', // String como viene de la API
                gif_url: null, // Asegurar que gif_url sea null
                is_public: true
            });
