...
const API_CACHE = 'fitness-api-v3';
const IMAGE_CACHE = 'fitness-images-v3';
...
// APIs que deben ser cacheadas para offline
...
// Tiempo máximo de cache para APIs (en milisegundos)
...
// Función para sincronizar cola offline (se llamará desde la app)
async function syncOfflineQueue() {
  // Esta función será llamada cuando la app vuelva online
  // La lógica real de sincronización está en offlineQueue.js
