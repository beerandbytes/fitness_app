...
const AnimatedExerciseBackground = () => {
  ...
  // Iconos disponibles de lucide-react - usar useMemo para evitar recreación
  ...
  // Configuración de iconos con posiciones y propiedades - usar useMemo para evitar recreación
  ...
  // Generar partículas con valores aleatorios una sola vez usando useState con función de inicialización
  ...
  // Generar líneas con valores aleatorios una sola vez usando useState con función de inicialización
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Animar partículas
      particlesRef.current.forEach((particleEl) => {
