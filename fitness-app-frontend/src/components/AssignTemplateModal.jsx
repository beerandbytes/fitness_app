...
const AssignTemplateModal = ({ open, onOpenChange, clientId, clientEmail, type = 'routine', preSelectedTemplateId, onSuccess }) => {
    ...
    return (
        <Dialog.Root open={open} onOpenChange={onOpenChange}>
            <Dialog.Portal>
                ...
                <Dialog.Content className="fixed top-0 md:top-1/2 left-0 md:left-1/2 md:transform md:-translate-x-1/2 md:-translate-y-1/2 backdrop-blur-xl bg-white/60 dark:bg-black/60 rounded-t-3xl md:rounded-3xl shadow-xl p-6 w-full md:w-[calc(100%-2rem)] md:mx-4 max-w-2xl max-h-[90vh] md:max-h-[90vh] h-[90vh] md:h-auto overflow-y-auto z-50 border border-gray-200/50 dark:border-gray-800/50">
