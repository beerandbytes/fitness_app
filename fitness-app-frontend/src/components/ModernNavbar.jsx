                    ...
                    <div className="flex items-center gap-1.5 md:gap-2 xl:gap-3 flex-shrink-0" role="toolbar" aria-label="Acciones de usuario">
                        ...
                        {user && (
                            <button
                                ...
                                className="md:hidden w-11 h-11 min-w-[44px] min-h-[44px] flex items-center justify-center rounded-lg text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
                                    ...
                                    <DropdownMenu.Portal>
                                        ...
                                        >
                                            ...
                                            <DropdownMenu.Item
                                                ...
                                                className="text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-xl transition-colors py-2.5 px-3 cursor-pointer outline-none flex items-center gap-2"
                                            >
                                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                                                </svg>
                                                Atajos de Teclado
                                                <span className="ml-auto text-xs text-gray-500 dark:text-gray-400">Ctrl+K</span>
                                            </DropdownMenu.Item>
                                            <div className="h-px bg-gray-200 dark:bg-gray-800 my-2"></div>
                                            <DropdownMenu.Item
