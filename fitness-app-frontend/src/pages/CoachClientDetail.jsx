...
import { CoachClientDetailSkeleton } from '../components/CoachClientDetailSkeleton';
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="text-right flex items-center gap-4">
                            <button
                                ...
                                className="flex items-center gap-2 px-4 py-2 bg-blue-600 dark:bg-blue-500 text-white rounded-xl hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors font-medium"
                            >
