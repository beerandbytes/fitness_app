...
import { DietPageSkeleton } from '../components/DietPageSkeleton';
                ...
                <div className="flex items-center justify-end mb-8">
                    <div className="flex items-center gap-3">
                        <button
                            ...
                            className="w-11 h-11 sm:w-10 sm:h-10 rounded-full backdrop-blur-md bg-white/60 dark:bg-black/60 border border-gray-200/50 dark:border-gray-800/50 flex items-center justify-center hover:bg-white/80 dark:hover:bg-black/80 hover:border-gray-300/50 dark:hover:border-gray-700/50 transition-all duration-300 text-gray-900 dark:text-white shadow-sm hover:shadow-md min-w-[44px] min-h-[44px]"
                        ...
                        <input
                            type="date"
                            className="px-4 py-2 min-h-[44px] backdrop-blur-md bg-white/60 dark:bg-black/60 border border-gray-200/50 dark:border-gray-800/50 rounded-xl text-center text-sm font-medium focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 dark:focus:border-blue-400 text-gray-900 dark:text-white transition-all duration-300 shadow-sm hover:shadow-md"
                            value={formattedDate}
                            onChange={(e) => {
                        ...
                        <div className="backdrop-blur-xl bg-white/60 dark:bg-black/60 rounded-3xl border border-gray-200/50 dark:border-gray-800/50 overflow-hidden shadow-sm hover:shadow-lg transition-all duration-500">
                            ...
                            {mealItems.length === 0 ? (
                                <EmptyState
                                    ...
                                    description="Añade tu primera comida para comenzar a llevar un registro de tu alimentación y calorías."
                                    actionLabel="Añadir Comida"
                                    actionOnClick={() => {
                                        // Trigger food search/add modal if available
                                        const addButton = document.querySelector('[data-food-add]');
